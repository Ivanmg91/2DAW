<?php
    ...
    $multiplicando_anterior = $_COOKIE["multiplicando"] ?? null;
    $multiplicador_anterior = $_COOKIE["multiplicador"] ?? null;

    setcookie("multiplicador", $multiplicador, time() + (60*60*24 * 30), "/");
    setcookie("multiplicando", $multiplicando, time() + (60*60*24 * 30), "/");
