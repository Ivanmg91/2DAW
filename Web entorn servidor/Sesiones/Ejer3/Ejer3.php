<?php
    ...
    echo "Numero actual: " . ($n2_actual ?? "No enviado") . "<br>";

    echo "Resulutado: $resultado<br><br>";
    ...
    echo "Numero anterior: " . ($n2_anterior ?? "No hay datos anteriores") . "<br>";

    echo "Resultado anterior: $resultado<br><br>";
